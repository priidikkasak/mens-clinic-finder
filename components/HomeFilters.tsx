...
export default function HomeFilters() {
  ...
  const hasFilters = cats.length > 0 || country
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div>
        ...
        <div style={{ position: 'relative' }}>
          ...
          <svg style={{ pointerEvents: 'none', position: 'absolute', right: 12, top: '50%', transform: 'translateY(-50%)', color: 'var(--text-3)' }}
